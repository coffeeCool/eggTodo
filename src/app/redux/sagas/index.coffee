...
Async =
  ...
  fetch: (action) ->
    try
      todos = yield sagaEffects.call todos
    catch ex
      throw new Error ex
    return unless todos
  ...
  delete: (action) ->
    try
      newTodo = yield sagaEffects.call deleteTodo
      , action.payload
    catch ex
      throw new Error ex
  ...
  create: (action) ->
    try
      newTodo = yield sagaEffects.call addTodo
      , action.payload
    catch ex
      throw new Error ex
    return unless newTodo
  ...
  update: (action) ->
    try
      newTodo = yield sagaEffects.call updateTodo
      , action.payload
    catch ex
      throw new Error ex
    return unless newTodo
